#driver for M5Stick C
#Translated by Guy Carver from the ST7735 sample code.
#Modified for micropython-esp32 by boochow 
#Modified for M5Stick-C by usini
...
class TFT(object) :
  ...
  def __init__( self) :
    ...
    self.cs(1)
    self.spi = SPI(1, baudrate=27000000,polarity=0, phase=0, bits=8, firstbit=SPI.MSB,sck=Pin(13), mosi=Pin(15))
